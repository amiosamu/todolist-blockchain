...
declare const _default: (params: BadgeStylesParams, options?: import("@mantine/styles").UseStylesOptions<"outline" | "light" | "dot" | "filled" | "rightSection" | "gradient" | "root" | "inner" | "leftSection">) => {
