...
const Avatar = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Avatar", defaultProps, props), {
    component,
    className,
    size,
    src,
  ...
  const { classes, cx } = Avatar_styles['default']({ color, radius, size }, { classNames, styles: styles$1, name: "Avatar" });
